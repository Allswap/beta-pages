    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the AllSwap protocol have made
      ...
      return (
        <div>
          <p>Attention ALLSWAP Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with ALLSWAP is ALLSWAP/yCRV
            (Curve yPool tokens)
          </p>
