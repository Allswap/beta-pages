...
import AllSwapAbi from './abi/allswap.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.allswap = new this.web3.eth.Contract(AllSwapAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.allswap, contractAddresses.allswap[networkId])
  ...
  setDefaultAccount(account) {
    this.allswap.options.from = account
